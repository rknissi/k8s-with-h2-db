...
public class PersonAvro extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -5099597508651980684L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"PersonAvro\",\"namespace\":\"com.example.demo.data\",\"fields\":[{\"name\":\"id\",\"type\":\"long\"},{\"name\":\"name\",\"type\":\"string\"},{\"name\":\"age\",\"type\":\"long\"}]}");
   ...
   */
  public static com.example.demo.data.PersonAvro.Builder newBuilder() {
    return new com.example.demo.data.PersonAvro.Builder();
  }
   ...
   * @return A new PersonAvro RecordBuilder
   */
  public static com.example.demo.data.PersonAvro.Builder newBuilder(com.example.demo.data.PersonAvro.Builder other) {
    return new com.example.demo.data.PersonAvro.Builder(other);
  }
   ...
   * @return A new PersonAvro RecordBuilder
   */
  public static com.example.demo.data.PersonAvro.Builder newBuilder(com.example.demo.data.PersonAvro other) {
    return new com.example.demo.data.PersonAvro.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<PersonAvro>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.example.demo.data.PersonAvro.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.example.demo.data.PersonAvro other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.demo.data.PersonAvro.Builder setId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.demo.data.PersonAvro.Builder clearId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.demo.data.PersonAvro.Builder setName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.demo.data.PersonAvro.Builder clearName() {
      name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.demo.data.PersonAvro.Builder setAge(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.demo.data.PersonAvro.Builder clearAge() {
